...
## Финальные задачи спринта
<details>
<summary>
<b>A. Ближайший ноль (<a href="a_nearest_zero.py">a_nearest_zero.py</a>)</b>
</summary>
...
<details>
<summary>
<b>B. Ловкость рук (<a href="b_sleight_of_hand.py">b_sleight_of_hand.py</a>)</b>
 </summary>
